...
""" % bcb_dev)
  ...
  squid_version = target_info.GetBuildProp("ro.squid")
  build_id = target_info.GetBuildProp("ro.build.id")
  build_date = target_info.GetBuildProp("org.pixelexperience.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.product.device")

  script.Print("----------------------------------------------");
  script.Print("              S-Q-U-I-D");
  script.Print("               by SyedSajid");
  script.Print("----------------------------------------------");
  script.Print(" Android version : %s"%(android_version));
  script.Print(" Squid  version  :  %s"%(Squid_version));
  script.Print(" Build id        : %s"%(build_id));
  script.Print(" Build date      : %s"%(build_date));
  script.Print(" Security patch  : %s"%(security_patch));
  script.Print(" Device          : %s"%(device));
  script.Print("----------------------------------------------");
  script.Print("       @Telegram --> https://t.me/Squid_os    ");
  script.Print("----------------------------------------------");
